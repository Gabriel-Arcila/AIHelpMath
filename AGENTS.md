...
| `tdd` | Guía para desarrollo guiado por pruebas (Test-Driven Development) usando el ciclo red-green-refactor, evitando acoplamiento a la implementación, datos hardcodeados y definiendo costuras (seams) de prueba. | Cuando se requiera desarrollar características o corregir bugs test-first, se mencione 'red-green-refactor', o se requieran pruebas de integración/unitarias estructuradas. | `.agents/skills/tdd/SKILL.md` |
